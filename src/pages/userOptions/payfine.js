...
const Payfine = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <h1 className="text-3xl font-bold mb-6">Pay Fine</h1>
      <div className="bg-white shadow p-6 rounded-lg w-80">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="Building Fine">Building Fine</option>
            <option value="Encroachment Fine">Encroachment fine</option>
            <option value="Building Tax">Other option</option>
          </select>
        </div>
        <div className="mb-4">
